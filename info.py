...
# Bot information
API_ID = environ.get('API_ID', '28810170')
if len(API_ID) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002038604520 -1002126690549').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002118885905')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', 'https://t.me/supp0rt_group')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://marktatebusinessmail:8vG90srWx54T2bXk@cluster0.nn6od.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
